...
- (void)drawRect:(CGRect)rect
{
    ...
    CGSize size = [numberString sizeWithAttributes:
                   @{NSFontAttributeName:self.font}];
    
    CGSize numberSize = CGSizeMake(ceilf(size.width), ceilf(size.height));
    ...
    [numberString drawAtPoint:textPt withAttributes:attrsDictionary];
