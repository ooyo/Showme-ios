...
@interface MapViewListViewController ()

@end

@implementation MapViewListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.buttonUserTapAction = ^(id sender){
        ...
        self.selectedPlaceID = [[allEventArray objectAtIndex:indexPath.row] objectForKey:@"_id"];
        ...
        smallViewController.selectedEvent =  self.selectedPlaceID;
...
{
    [self performSegueWithIdentifier:@"map_list_event_detail" sender:self];
}

-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"map_list_event_detail"]) {
        ...
        eventDetailController.selectedCategory = @"";
    }
}
...
-(void)sendHTTPPost{
    ...
    NSError *error1;
    NSURL * url = [NSURL URLWithString:placeEventList];
    ...
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys: [defaults objectForKey:@"userid"], @"userid", self.selectedPlaceID, @"place_id", nil];
...
- (void)URLSession:(NSURLSession *)session task:(NSURLSessionTask *)task didCompleteWithError:(NSError *)error
{
    if(error == nil)
    {
        ...
        NSLog(@"SelectedPlaceID :%@", self.selectedPlaceID);
