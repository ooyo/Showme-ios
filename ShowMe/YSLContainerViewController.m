...
/*    if([self.startingTabIndex integerValue] > 0){
         [self scrollMenuViewSelectedIndex:[self.startingTabIndex integerValue]];
         self.menuView.itemIndicatorColor = [UIColor whiteColor];
